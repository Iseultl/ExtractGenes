...
HEADER = ['annotation_id', 'assembly_accession', 'species', 'lineage', 'busco_count', 'complete',
                'single', 'duplicated', 'fragmented', 'missing', 'Well_annotated', 'Upstream', 'Downstream', 'Skipped', 'Out_of_frame', 'Spliced', 'Stop_codon', 'Selenocysteine_Gene_Count', "Selenocysteine_GTF_Count", "Selenocysteine_GTF_Count_Genes"]
